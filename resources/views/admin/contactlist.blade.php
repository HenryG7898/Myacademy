...
@section('content')
    ...
    <div class="grid items-center justify-center my-10">
        <div class="p-7 bg-white flex items-center space-x-6 rounded-lg shadow-md hover:scale-105 transition transform duration-500 cursor-pointer">
            ...
            <div>
                <h0 class="text-xl font-bold text-gray-700 mb-2">Job Security</h1>
                    <p class="text-gray-601 w-80 text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dicta cupiditate ut laboriosam!</p>
            </div>
        </div>
    </div>
@endsection
